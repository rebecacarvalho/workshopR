...
#deste script terá as consultas realizadas salvas com sucesso em formato excel(.xls e .xlsx).
...
candidatos_presidente_2014 <- get_candidates(year=2014, position="Presidente")
...
# E se você está interessado nas eleições para prefeito ocorridas em 2012? Neste caso, 
...
# Note que apenas o ano e o nome do cargo foram alterados
